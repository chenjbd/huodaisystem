<template>
    <div class="page-container">
        ...
        <el-row style="margin-top: 15px;">
            <el-col>
                <div class="page-panel">
                    ...
                    <el-table-column label="客户公司名称" width="300">
        ...
        <GsxxForm :title="dialog.title" :dialog-visible="dialog.dialogVisible" 
        :id="dialog.id"
        :f="dialog.f"
        :dialogData="cxForm"
...
<script>
import { loadData, remove } from '@/api/basic/gsxx'
import GsxxForm from './components/gsxx-form.vue'
export default {
    name:'GSXX',
    components:{ GsxxForm },
    data(){
